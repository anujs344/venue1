...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/couple-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 17:32:33 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab-1">
                                <div class="container">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <!-- /.form-heading-title -->
                                        <!-- register-form -->
                                        <form action="{{route('registercouple')}}" method="post">
                                            @csrf
                                            <!-- form -->
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="name" type="text" name="name" placeholder="Name" class="form-control" required>@error('name')
                                                            {{$message}}
                                                        @enderror
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="weddingdate" name="wedding_date" type="text" placeholder="Wedding Date" class="form-control input-md" required="">@error('wedding_date')
                                                        {{$message}}
                                                    @enderror
                            ...
                            <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab-2">
                                <div class="container">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <!-- /.login-form-heading-title  -->
                                        <!-- login-form-->
                                        <form action="{{route('couplelogin')}}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                    <!-- Text input-->
                                                    <div class="form-group">
                                                        ...
                                                        <input id="username" type="email" name="email" placeholder="Email" class="form-control" required>@error('email')
                                                        {{$message}}
                                                    @enderror
                                                    </div>
                                                </div>
