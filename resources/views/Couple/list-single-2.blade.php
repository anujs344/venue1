...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/list-single-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 17:31:57 GMT -->
<head>
    <meta charset="utf-8">
...
<!-- header -->
    ...
    <div class="list-single-carousel">
        <div class="owl-carousel owl-theme owl-second">
            <div class="item">
                <img src="{{asset('assets/"images/vendor-carousel-img-1.jpg')}}" alt="">
            </div>
            <div class="item">
                <img src="{{asset('assets/"images/vendor-carousel-img-2.jpg')}}" alt="">
            </div>
            <div class="item">
                <img src="{{asset('assets/"images/vendor-carousel-img-3.jpg')}}" alt="">
            </div>
            <div class="item">
                <img src="{{asset('assets/"images/vendor-carousel-img-4.jpg')}}" alt="">
            </div>
            <div class="item">
                <img src="{{asset('assets/"images/vendor-carousel-img-2.jpg')}}" alt="">
            </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                        <div class="vendor-head text-left">
                            <h2 class="mb10">Heading Title for Wedding Venue</h2>
                            <p class="vendor-address">3170 Stonecoal Road Napoleon, OH 43545. <a href="#location" class="btn-secondary-link ml-2">View Map</a> </p>
                        </div>
                    </div>
                    ...
                    <div class="">
                        ...
                        <div class="card border card-shadow-none ">
                            ...
                            <div class="card-header bg-white mb0">
                                <div class="review-user">
                                    <div class="user-img"> <img src="{{asset('assets/"images/review-pic-1.jpg')}}" alt="star rating jquery" class="rounded-circle"></div>
                                    <div class="user-meta">
                        ...
                        <div class="card border card-shadow-none ">
                            ...
                            <div class="card-header bg-white mb0">
                                <!-- review-user -->
                                <div class="review-user">
                                    <div class="user-img"> <img src="{{asset('assets/"images/review-pic-2.jpg')}}" alt="star rating jquery" class="rounded-circle"></div>
                                    <div class="user-meta">
                        ...
                        <div class="card border card-shadow-none ">
                            ...
                            <div class="card-header bg-white mb0">
                                <!-- review-user -->
                                <div class="review-user">
                                    <div class="user-img"> <img src="{{asset('assets/"images/review-pic-3.jpg')}}" alt="star rating jquery" class="rounded-circle"></div>
                                    <div class="user-meta">
                    ...
                    <div class="sidebar-venue">
                        ...
                        <div class="vendor-owner-profile mb30">
                            <div class="vendor-owner-profile-head">
                                <div class="vendor-owner-profile-img"><img src="{{asset('assets/"images/admin-pic.jpg')}}" class="rounded-circle" alt=""></div>
                                <h4 class="vendor-owner-name mb0">Roberto F. McGill</h4>
                            </div>
                            <div class="vendor-owner-profile-content">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><span class="mr-2 text-default"><i class="fas fa-fw fa-map-marker-alt"></i></span>1847 Providence Lane Alhambra, CA 91801</li>
                                    <li class="list-group-item"><span class="mr-2  text-default"><i class="fas fa-fw fa-phone"></i></span>(123) 123 4567</li>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="footer-widget">
                        <a href="#"><img src="{{asset('assets/"images/footer-logo.png')}}" alt="" class="mb20"></a>
...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/list-single-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 17:32:01 GMT -->
</html>