...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Rubik:300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">
    ...
    <!-- Fontello icon -->
    <link href="{{asset('asset/fontello/css/fontello.css')}}" rel="stylesheet">
    <!-- Favicon icon -->
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zoomimg"><img src="{{asset('asset/images/vendor-img-1.jpg')}}" alt="" class="img-fluid"></div></a>
                    ...
                    <div class="vendor-thumbnail list-view">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zooming"><img src="{{asset('asset/images/vendor-img-2.jpg')}}" alt=""  class="img-fluid"></div></a>
                                    <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 pl-0">
                    ...
                    <div class="vendor-thumbnail list-view">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zooming"><img src="{{asset('asset/images/vendor-img-3.jpg')}}" alt=""  class="img-fluid"></div></a>
                                    <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                                </div>
                            </div>
                            <!-- /.Vendor img -->
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 pl-0">
                                <div class="vendor-content">
                                    <!-- Vendor Content -->
                                    <h2 class="vendor-title"><a href="#" class="title">Wedding Venue Title Name</a></h2>
                                    <p class="vendor-address">Jaipur, Rajasthan.</p>
                                </div>
                                <div class="vendor-meta m-0">
                                    <div class="vendor-meta-item vendor-meta-item-bordered">
                                        <span class="vendor-price">
                    ...
                    <div class="vendor-thumbnail list-view">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zooming"><img src="{{asset('asset/images/vendor-img-4.jpg')}}" alt=""  class="img-fluid"></div></a>
                                    <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                                </div>
                            </div>
                            <!-- /.Vendor img -->
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <div class="footer-widget">
                        <a href="#"><img src="{{asset('asset/images/footer-logo.png" alt="" class="mb20"></a>
