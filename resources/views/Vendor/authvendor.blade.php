...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/vendor-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 17:31:34 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row ">
                <div class="offset-xl-3 col-xl-6 offset-lg-3 col-lg-6 col-md-12 col-sm-12 col-12  ">
                    ...
                    <div class="vendor-head">
                        <a href="index.html"><img src="{{asset('assets/images/logo.png')}}" alt="Wedding Vendor & Supplier Directory HTML Template "></a>
                    </div>
                    <!-- /.vendor head -->
                    <div class="st-tab">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab-1">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <!-- /.vendor title -->
                                    <form action="{{route('registervendor')}}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                               <!-- Text input-->
                                                <div class="form-group">
                                                    ...
                                                    <input id="bussinessname" type="text" name="bussiness_name" placeholder="Bussiness Name" class="form-control" required>@error('bussiness_name')
                                                        {{$message}}
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="name" type="text" name="username" placeholder="User Name" class="form-control" required>@error('username')
                                                    {{$message}}
                                                @enderror
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                               <!-- Text input-->
                                                <div class="form-group service-form-group">
                                                    ...
                                                    <input id="email" type="email" placeholder="Email" name="email" class="form-control" required>@error('email')
                                                    {{$message}}
                                                @enderror
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                              <!-- Text input-->
                                                <div class="form-group service-form-group">
                                                    ...
                                                    <input id="passwordregister" type="password" name="password" placeholder="Password" class="form-control" required>@error('password')
                                                    {{$message}}
                                                @enderror
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <!-- select -->
                                                <div class="form-group">
                                                    <select class="wide mb20" plcaholder="vendor" name="vendor">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                              <!-- Text input-->
                                                <div class="form-group">
                                                    ...
                                                    <input id="username" type="text" name="username" placeholder="User Name" class="form-control" required>@error('username')
                                                        {{$message}}
                                                    @enderror
                                                </div>
                                            </div>
                                           <!-- Text input-->
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <div class="form-group service-form-group">
                                                    ...
                                                    <input id="passwordlogin" type="password" name="password" placeholder="Password" class="form-control" required>@error('password')
                                                    {{$message}}
                                                @enderror
                                                </div>
                                            </div>
