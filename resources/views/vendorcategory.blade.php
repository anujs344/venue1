...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/vendor-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 17:32:06 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card-category">
                    <div class="category-image zoomimg"><a href="{{route('showsingleviewcategory',$categoryname)}}"><img src="{{asset('assets/images/catergory-venue.jpg')}}" alt=""></a></div>
                    <div class="category-content">
                        <h3 class="cateogry-title"> <a href="{{route('showsingleviewcategory',$categoryname)}}">{{$categoryname}}</a> <span class="category-count">(12)</span></h3>
                    </div>
                </div>
            </div>
            @endforeach
